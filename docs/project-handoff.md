...
- Maven unit/API verification passed with 100 tests. Full Maven verification was attempted but its Testcontainers phase could not initialize Docker from the local shell; SIT startup and runtime verification provide the deployment evidence. PR #28 remains open for review and merge.
