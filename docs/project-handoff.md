...
- Infra PR [#38](https://github.com/digital-bank-java/infra-sit/pull/38) is merged; its Docker Desktop Fluent Bit fallback still requires post-merge SIT/OpenSearch evidence before `.github#94` can be closed. The remaining reviewable PRs are account-service #42, infra-sit #39, and `.github` #245.
