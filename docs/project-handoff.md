...
- Ledger Service PR #20 completed Maven, Helm, and container CI checks successfully. The PR and Bug #238 remain open only for review/merge and final tracking closeout.
